...
namespace EGuardian.Views.Eventos.Aplicaciones
{
    public class AplicacionesFiltradoPage : ContentPage
    {
        RelativeLayout Contenido;
        List<aplicaciones> apps = App.Database.GetAplicaciones().ToList();
        public ExtendedListView AplicacionesContenido;

        void AplicacionesContenido_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            MessagingCenter.Send<AplicacionesFiltradoPage>(this, "OK");
            Navigation.PopModalAsync();
        }

        public AplicacionesFiltradoPage()
        {
            ...
            AplicacionesContenido = new ExtendedListView
            {
                Margin = 0,
            ...
            AplicacionesContenido.ItemSelected += AplicacionesContenido_ItemSelected;
                ...
                Children =
                    {
                        new Grid
                        {
                            ...
                            Children = { AplicacionesContenido }
                        },
